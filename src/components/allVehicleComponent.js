    ...
    <div style={{ backgroundColor: 'lightgrey', paddingTop: '5rem' }}>
      ...
      <div style={styles.vehicleGrid}>
        {vehicles.map((vehicle) => (
          <div key={vehicle.vehicle_id} className="vehicle" style={styles.vehicle}>
            ...
            <button style={{ padding: '.5em', backgroundColor: 'orange', borderRadius: '10rem'}}>
            <Link to={`/car/${vehicle.vehicle_id}`}>Reserve</Link>
            </button>
          </div>
        ))}
      </div>
